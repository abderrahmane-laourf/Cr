          ...
          <table className="w-full">
            <thead className="bg-slate-50 border-b border-slate-100">
              <tr>
                ...
                <th className="text-left px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">ID API</th>
            ...
            <tbody className="divide-y divide-slate-50">
              {filteredBusinesses.map((business) => (
                <tr key={business.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-slate-600 font-mono bg-slate-50 rounded px-2 py-1 inline-block mt-2 md:mt-0 md:bg-transparent md:bg-none">
                    {business.apiId}
                  </td>
