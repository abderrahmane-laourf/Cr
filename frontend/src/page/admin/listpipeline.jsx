...
export default function ColisManagement() {
  ...
  const loadPipelineStages = () => {
    ...
    if (saved) {
      const allPipelines = JSON.parse(saved);
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-8">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Liste des Colis</h1>
                <p className="text-slate-500 mt-1 font-medium">Gérez vos commandes par étape</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {pipelines.length > 0 && (
                <select
                  ...
                  className="px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white border-2 border-blue-500 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all shadow-lg"
                >
              ...
              <select
                ...
                className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
              >
              ...
              <button
                ...
                className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl hover:bg-slate-100 flex items-center gap-2 text-slate-700 font-semibold transition-all"
              >
        ...
        {/* Kanban Board */}
        <div className="flex flex-col md:flex-row gap-4 overflow-x-auto pb-4 min-h-[calc(100vh-200px)]">
          {stages.map((stage) => {
