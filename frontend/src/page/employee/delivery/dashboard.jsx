...
export default function DeliveryDashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-20 px-4 sm:px-0">
      ...
      <div className="w-full bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 rounded-3xl p-6 shadow-2xl shadow-emerald-500/30 border border-emerald-400/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
            <p className="text-emerald-100 text-xs font-bold uppercase tracking-wider mb-1">Ch7al Rbti</p>
            <p className="text-white text-3xl font-black">
              ...
              <span className="text-lg ml-1 text-emerald-200">DH</span>
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
            <p className="text-emerald-100 text-xs font-bold uppercase tracking-wider mb-1">Ch7al Lba9i</p>
            <p className="text-white text-3xl font-black">
              {(() => {
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 sm:col-span-2 lg:col-span-1">
            <p className="text-emerald-100 text-xs font-bold uppercase tracking-wider mb-1">Total Possible</p>
            <p className="text-white text-3xl font-black">
              {(() => {
      ...
      <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
            />
          </div>
          
          {/* Product Filter */}
          <div className="relative">
            <label className="block text-xs font-bold text-slate-600 mb-2 uppercase tracking-wide">Produit</label>
            <select
              value={filterProduct}
              onChange={(e) => setFilterProduct(e.target.value)}
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none text-sm sm:text-base"
            >
        ...
        {(filterDate || filterProduct !== 'all') && (
          <button
            ...
            className="mt-3 text-xs sm:text-sm text-blue-600 hover:text-blue-700 font-bold flex items-center gap-1"
          >
            <XCircle size={14} />
      ...
      <div>
        <h3 className="font-bold text-slate-800 mb-3 sm:mb-4 text-base sm:text-lg">Prochain Arrêt</h3>
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-100 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-base sm:text-lg">
                1
            </div>
            <div className="flex-1 w-full">
                <h4 className="font-bold text-slate-800 text-sm sm:text-base">Mme. Fatima Zahra</h4>
                <p className="text-xs sm:text-sm text-slate-500">Quartier Talborjt, Rue 12</p>
            ...
            <a href="tel:+212600000000" className="p-2 sm:p-3 bg-emerald-50 text-emerald-600 rounded-full hover:bg-emerald-100 self-end sm:self-center">
                <Phone size={18} />
            </a>
        </div>
      </div>
